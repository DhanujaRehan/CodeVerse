...
import com.example.codeverse.Student.Adapters.CreditCardAdapter;
...
public class MakePaymentFragment extends Fragment {
    ...
    private void setupCardCarousel() {
        ...
        CreditCardAdapter adapter = new CreditCardAdapter(getContext(), creditCards, (card, position) -> {
        ...
        fabAddCard.setOnClickListener(v -> {
            Toast.makeText(getContext(), "Add new card feature coming soon", Toast.LENGTH_SHORT).show();
        });
    }
    ...
    private void updateCardPreview(CreditCard card) {
        ...
        // Uncomment and adjust these lines when you have the proper IDs in your layout
        // View cardBackground = cardPreview.findViewById(R.id.card_preview_bg);
        // TextView tvCardNumber = cardPreview.findViewById(R.id.card_preview_number);
        // TextView tvCardHolder = cardPreview.findViewById(R.id.card_preview_holder);
        // TextView tvCardExpiry = cardPreview.findViewById(R.id.card_preview_expiry);
        // ImageView ivCardNetwork = cardPreview.findViewById(R.id.card_preview_network);

        // Update the preview card with the selected card's details
//         cardBackground.setBackgroundResource(card.getBackgroundResId());
//         tvCardNumber.setText(card.getFormattedCardNumber());
//         tvCardHolder.setText(card.getCardHolder());
//         tvCardExpiry.setText(card.getExpiryDate());
//         ivCardNetwork.setImageResource(card.getCardTypeImage());
    }
