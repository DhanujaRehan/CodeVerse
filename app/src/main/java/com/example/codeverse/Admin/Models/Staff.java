...
public class Staff implements Serializable {
    ...
    public Staff(String fullName, String email, String contactNumber, String nicNumber,
                 String gender, String dateOfBirth, String position) {
    ...
    public String getProgramCoordinating() { return programCoordinating; }
    public void setProgramCoordinating(String programCoordinating) { this.programCoordinating = programCoordinating; }
